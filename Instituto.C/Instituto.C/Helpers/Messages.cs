namespace Instituto.C.Helpers
{
    public static class Messages
    {
        ...
        public const string RegEx = "El {0} solo puede contener letras y espacios (3 a 100 caracteres).";
        public const string Dni = "El DNI debe tener 7 u 8 dígitos, sin puntos ni letras.";
        public const string PasswordIncorrecta= "La contraseña no es la misma.";
